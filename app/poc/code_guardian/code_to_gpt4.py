...
llm = ChatOpenAI(openai_api_key="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", model_name="gpt-4", max_tokens=4000)
...
new_filename = '/home/users/aswin1906/projects/ai/poc/llm/app/poc/code_guardian/fix/code_guardian_fixed.py'

lines= llm_result

with open(new_filename, 'w') as file:
    file.writelines(lines)
print("Fixed code written to a new file called code_guardian_fixed.py.")
